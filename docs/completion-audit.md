...
| Schema, atomic quad patches, failed-batch rollback, concurrency, HTTP streaming, and managed D1     | Proven within documented D1 semantics       | source/workerd integration tests, endpoint stream tests, and the deployed acceptance run                                                        |
...
| Independent clean-room integration                                                                  | Proven on third fresh-project run           | final 2026-07-20 PASS summarized in `docs/deployed-e2e.md`                                                                                      |
...
`docs/deployed-e2e.md`. Later releases must rerun proportionate hosted checks
when Worker or schema behavior changes.
